# name: sequential_IC.py
# date: 3 August 2021
# auth: Rui Diaz-Pacheco based on Brandon Sorbom, Zach Hartwig, Erica Salazar 2018 work
# mail: rdiazpacheco@cfs.energy (bsorbom@psfc.mit.edu, hartwig@psfc.mit.edu, erica@psfc.mit.edu)
#
