# -*- coding: utf-8 -*-
"""
Created on Tue Feb  1 11:30:05 2022
...
#%% Transverse compression test Bus Bar
...
#T_full_array = list(range(70, 300, 5)) #T_min = 77, T_max = 290, T_step = 1
...
LIA = calc_LIA_Const(TH = 290, TL = 70, n = 20, df = df_vals)
LIAsc = "{:e}".format(calc_LIA_Const(TH = 290, TL = 70, n = 20, df = df_vals))

Imax = 16000
Len = .55
CrossA = 10000*(Len*Imax)/LIA


LIA2 = 1.93e7
LIA2sc = "{:e}".format(LIA2)

Imax = 16000
Len = .55
CrossA2 = 10000*(Len*Imax)/LIA2

print(LIAsc,"A/m")
print(LIA2sc,"A/m")
print(CrossA,"cm^2 Sweep")
print(CrossA2,"cm^2 Constant LI/A")
